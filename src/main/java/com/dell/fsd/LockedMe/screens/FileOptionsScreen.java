...
import com.dell.fsd.LockedMe.entities.Directory;
...
public class FileOptionsScreen implements Screen {
    ...
    public void AddFile() {
        ...
        System.out.println("You are creating a file named: " + fileName);
		...
		try {
			...
			File file = new File(dir.getName() + fileName);
		      ...
		      if (file.createNewFile()) {
		        ...
		        System.out.println("This File Already Exits, no need to create another");
		      }
		}catch (IOException e){
